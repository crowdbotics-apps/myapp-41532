"""
Django settings for myapp_41532 project.
...
WSGI_APPLICATION = 'myapp_41532.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_41532 API",
    "DESCRIPTION": "API documentation for myapp_41532 App",
    "VERSION": "v1",
}
